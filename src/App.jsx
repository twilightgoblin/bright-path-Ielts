...
const App = () => {
  const demoItems = [
    { link: '#', text: 'Speaking', image: 'https://picsum.photos/600/400?random=1' },
    { link: '#', text: 'Listening', image: 'https://picsum.photos/600/400?random=2' },
    { link: '#', text: 'Verbal', image: 'https://picsum.photos/600/400?random=3' },
    { link: '#', text: 'Logical Reasoning', image: 'https://picsum.photos/600/400?random=4' }
  ];
  ...
  return (
    <div className="relative w-full">
      ...
      <div>
        {/* Features Section */}
        <section id="home" className="bg-purple-300 flex flex-col items-center justify-start pt-40 space-y-12">
          <h1 className="text-5xl font-bold text-purple-700">Features</h1>
...
<section
  id="services"
  className="min-h-screen bg-gradient-to-b from-white to-yellow-50 flex flex-col items-start justify-start pt-32 px-8 md:px-20 space-y-12"
>
  <h2 className="text-5xl font-extrabold text-yellow-700 border-l-4 border-yellow-500 pl-4">
    About Us
  </h2>

  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
    <div className="bg-white/20 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">
      <h3 className="text-xl font-bold text-yellow-700 mb-2">Our Mission</h3>
      <p className="text-gray-700">
        We help students master IELTS with immersive, personalized learning methods.
      </p>
    </div>

    <div className="bg-white/20 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">
      <h3 className="text-xl font-bold text-yellow-700 mb-2">Our Approach</h3>
      <p className="text-gray-700">
        Interactive lessons, real-world practice, and AI-powered feedback ensure rapid progress.
      </p>
    </div>
    ...
    <div className="bg-white/20 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">
      ...
      <p className="text-gray-700">
        To be the most trusted platform for IELTS preparation worldwide.
      </p>
    </div>
  </div>
</section>
